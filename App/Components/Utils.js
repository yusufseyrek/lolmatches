...
let Utils = {
    ...
    calculateDiffDate(matchCreation){
        ...
        var diff = Math.round(((currentDate - matchDate) / (24 * 3600 * 1000)))
        
        return diff ;
    },
    converMatchType(matchType){
        let formattedType = matchType.replace("_","");
        formattedType = formattedType.replace("_","").toLowerCase();
